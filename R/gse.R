...
#' head(dgeZscore)
#' 
#' @return A numeric matrix of z-scores with the same dimensions as the input
#' count matrix.
...
#' 
#' @return A \code{data.frame} containing merged CAMERA results.
#'
...
#' 
#' @return A \code{data.frame} containing CAMERA results across contrasts.
#'
#' @examples
